                        ...
                        <Form onSubmit={(e) => deleteUserName(e)}>
                            <Row className='mb-2 '>
                                <Col md={10} className={'pe-0 user-row'}>
                                    <ListGroup.Item
                                        className={(globalState.selectedUserName !== userData.summonerData.name ? 'bg-light' : 'bg-dark-subtle user-row-selected') + ' user-item'}
                                        as="li"
                                ...
                                <Col md={2} className='ps-0'>
                                    <Button variant="danger" type="submit" className='delete-user'>Delete</Button>
                                </Col>
                            </Row >
                        </Form>
            }
